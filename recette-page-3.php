						...
						<div class="row">
							...
							<div class="col-sm-8">
								<article class="entry" id="FIORE-DOREES">
									<a href="FIORE-DOREES.html">
									<figure class="box-1">
										<a href="FIORE-DOREES.html"><img alt="slider 5" class="img-responsive" src="images/slide-5.png"></a>
									</figure>
									<div class="entry-preview clearfix">
										...
										<h2>
											<a href="FIORE-DOREES.html">FIORE DORÉES</a>
										</h2>
								...
								<article class="entry" id="GRATIN-BASTARDO">
									<a href="GRATIN-BASTARDO.html">
									<figure class="box-1">
										<a href="GRATIN-BASTARDO.html"><img alt="slider 6" class="img-responsive" src="images/slide-6.png"></a>
									</figure>
									<div class="entry-preview clearfix">
										<!--<div class="entry-date">
											<span class="entry-day">21</span> <span class="entry-month">Jul</span>
										...
										<h2>
											<a href="GRATIN-BASTARDO.html">GRATIN BASTARDO</a>
										</h2>
										<!--<p style="text-align: justify;">
											<strong>Ingrédients</strong><br>
											<div class="row" style="margin-left: 50px;text-align: justify;">
												...
												<div class="col-sm-4">
													...
													250 g de Vecchio Bastardo<br>
													Di Fiore râpé <br>
													1 kg de pain rassis <br>
													75 cl de lait.
												</div>
												<div class="col-sm-4">
												...
												<div class="col-sm-4">
													...
													2 cuilleres a soupe de <br>
													creme liquide<br>
													150 g de jambon de <br>
													dinde fumé.
												</div>
											</div>
											...
											<div style="margin-left: 50px;text-align: justify;">
												...
												Couper le pain en petits morceaux dans un saladier, faire chauffer le lait puis le verser sur le pain, couvrir, laisser reposer 15 minutes.<br> 
												Battre les oufs avec la creme liquide, le beurre fondu, le sel, le poivre, un pincée de noix de muscade moulue puis ajouter le Vecchio Bastardo Di Fiore râpé (en réserver 50 g). <br>
