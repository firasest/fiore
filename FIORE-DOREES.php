...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/FIORE-DOREES.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="FIORE-DOREES" />
        <meta property="og:description"   content="Mélanger les ingrédients de la pâte jusqu'a former une jolie boule bien lisse. L'envelopper dans un linge propre et fariné, puis laisser reposer la pâte un minimum de 6 heures, un maximum de 12... " />
													
        <meta property="og:image"         content="http://fromagefiore.com/images/slide-5.png" />
				...
				<nav id="secondary-nav-bar" class="navbar navbar-default" style="background-color: #074529">
				  <div class="container">
				    <ul id="secondary-nav" class="nav navbar-nav" style="margin-top: 12px;">
				    	...
				    	<div class="col-sm-1"  style="color: #fff"> /</div>
				    	<div class="col-sm-5"><li><a class="active" class="soustitre" style="font-weight: bold;color: #fff;border-bottom: 3px solid #fff">FIORE DORÉES</a></li></div>
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<!--<ol class="breadcrumb">
					                  ...
					                  <li class="active">FIORE DORÉES</li>
				                </ol>-->
								<article class="entry" id="FIORE-DOREES">
									<figure class="box-1">
										<a><img alt="slider 5" class="img-responsive" src="images/slide-5.png"></a>
									</figure>
										...
										<p style="text-align: justify;">
											...
											<div class="row" style="margin-left: 50px;text-align: justify;">
														...
														<div class="col-sm-6">
															...
															Ingrédients pour la farce: <br>
															250g de Cacciotta Di Fiore<br>
															50g de Vecchio Bastardo Di Fiore <br>
											...
											<div style="margin-left: 50px;text-align: justify;">
														...
														<div style="text-decoration: underline">La veille : </div> <br>

														Mélanger les ingrédients de la pâte jusqu'a former une jolie boule bien lisse. L'envelopper dans un linge propre et fariné, puis laisser reposer la pâte un minimum de 6 heures, un maximum de 12. <br><br>

														<div style="text-decoration: underline">Le lendemain : </div> <br>

														Allumer votre four a 220° (Thermostat 8) Laver puis hacher grossierement le persil. Râper le Cacciotta Di Fiore et émietter le Vecchio Bastardo Di Fiore.<br>
														 Mélanger les trois ingrédients, saler, poivrer et former 30 petits tas égaux de 10g chacun. Sortir la pâte, l'étaler a la main et la couper en 30 parties égales.<br>
														  Les étaler une a une au rouleau en fines galettes plates.<br>
														   Mouiller leurs pourtours avec de l'eau, placer chaque petit tas de fromages au centre de chacune d'elles, refermer en deux comme des ravioles, décorer de sésames et les placer l'une apres l'autre sur une plaque préalablement beurrée.<br>
								...
								<div class="row">
								    <div class="col-sm-12 col-sm-offset-10">
								        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2FFIORE-DOREES.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
								    </div>
								</div>
								...
								<!--<nav class="text-center">
								  <ul class="pagination-product pagination">
								    <li>
								      <a href="recette-page-2.html" aria-label="Previous">
