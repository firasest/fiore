...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/foire-blanco.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="Saint remo" />
        <meta property="og:description"   content="Il existe actuellement des dizaines de variétés de fromages pâte molle et croûte fleurie et s'ils sont fabriqués selon un savoir-faire commun, notre 'Fiore Bianco' a sa particularité puisque nous avons su apporter un touche personelle a ce fromage ancestral. Ainsi notre 'Saint remo' n'est jamais tout a fait le même." />
        <meta property="og:image"         content="http://fromagefiore.com/images/molle/Fiore-bianco-di-Fiore.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/molle/Fiore-bianco-di-Fiore.png" class="img-product swipebox">
									<img class="img-responsive" src="images/molle/Fiore-bianco-di-Fiore.png" alt="Fiore-bianco-di-Fiore" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active" style="text-transform: uppercase;">Saint Rémo</li>
                </ol>
							<h1><span style="color:#1a761d">Saint</span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;"> Ré</span><span style="color:#CE2B37">mo</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            Il existe actuellement des dizaines de variétés de fromages pâte molle et croûte fleurie et s'ils sont fabriqués selon un savoir-faire commun, notre "Saint remo" a sa particularité puisque nous avons su apporter un touche personelle a ce fromage ancestral.
                            Ainsi notre "Fiore Bianco" n'est jamais tout a fait le même.
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  <div class="panel panel-default">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #ff5e00;;">
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Saint Rémo</center></td>
              <td style="color: #fff"><center>P02F020201</center></td>
              <td style="color: #fff"><center>0.500 kg</center></td>
              <td style="color: #fff"><center>2407810XXXXXX</center></td>
              <td style="color: #fff"><center>60 jours</center></td>
            </tr>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Ffoire-blanco.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
