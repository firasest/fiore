            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/molle/Fiore-bianco-di-Fiore.jpg" class="img-product swipebox">
									<img class="img-responsive" src="images/molle/Fiore-bianco-di-Fiore.jpg" alt="Fiore-bianco-di-Fiore" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">FIORE BIANCO</li>
                </ol>
							<h1><span style="color:#1a761d">FIORE</span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;"> BIAN</span><span style="color:#CE2B37">CO</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            Il existe actuellement des dizaines de variétés de fromages pâte molle et croûte fleurie et s'ils sont fabriqués selon un savoir-faire commun, notre "Fiore Bianco" a sa particularité puisque nous avons su apporter un touche personelle a ce fromage ancestral.
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #ff5e00;;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center> Bianco di Fiore</center></td>
