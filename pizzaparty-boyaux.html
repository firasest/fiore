...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/pizzaparty-boyaux.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="pizzaparty-boyaux" />
        <meta property="og:description"   content="PIZZA PARTY DI FIORELLA : Mozzarella preparation spécial pour pizza." />
        <meta property="og:image"         content="http://fromagefiore.com/images/a-base-alimentaire/Fiorella%20pizza%20party.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/a-base-alimentaire/Fiorella pizza party.png" class="img-product swipebox">
									<img class="img-responsive" src="images/a-base-alimentaire/Fiorella pizza party.png" alt="logo" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">PIZZAPARTY BOYAUX</li>
                </ol>
							<h1><span style="color:#1a761d">PIZZA </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">PARTY</span><span style="color:#CE2B37"> BOYAUX</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            PIZZA PARTY DI FIORELLA : Mozzarella preparation  spécial pour pizza.			
							</p>
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #1a761d;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Pizza party boyaux</center></td>
              <td style="color: #fff"><center>FA01F0401</center></td>
              <td style="color: #fff"><center>1.5 kg</center></td>
              <td style="color: #fff"><center>6191581000764</center></td>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fpizzaparty-boyaux.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
