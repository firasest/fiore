        ...
        <div class="container-fluid" id="main-container" style="background-image: url(images/nofromage.jpg);">
            ...
            <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/presse/Sicilien-al'ail.png" class="img-product swipebox">
									<img class="img-responsive" src="images/presse/Sicilien-al'ail.png" alt="Sicilien-al'ail" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">SICILIEN A l'AIL</li>
                </ol>
							<h1><span style="color:#1a761d">SICILIEN </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">A</span><span style="color:#CE2B37"> l'AIL</span></h1>
							<!--<h5>100G</h5>-->
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #744a29;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Sicilien al'ail</center></td>
              <td style="color: #fff"><center>P03F0300025</center></td>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fsicilien-al'ail.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
