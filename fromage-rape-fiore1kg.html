...
<head>
        <title>Fromage rapé fiore 1kg</title>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/fromage-rape-fiore1kg.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="Fromage rapé fiore 1kg" />
        <meta property="og:description"   content="Retrouvez le bon goût généreux et légèrement fruité du mix de 3 fromages à base de lait vache en  format râpé très pratique, ce fromage râpé fait succomber toute la famille au quotidien. Pour ajouter du fondant ou du croustillant à tous vos gratins, salades et  soupes..." />
        <meta property="og:image"         content="http://fromagefiore.com/images/rape/RAPE-FIORE-100-%-LAIT-1-KG.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/rape/RAPE-FIORE-100.png" class="img-product swipebox">
									<img class="img-responsive" src="images/rape/RAPE-FIORE-100.png" alt="RAPE-FIORE-1kg" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active" style="text-transform: uppercase;">Fromage râpé FIORE 1KG</li>
                </ol>
							<h1><span style="color:#1a761d">FROMAGE </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;"> râpé DI FIORE</span><span style="color:#CE2B37"> 1KG</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            Retrouvez le bon goût généreux et légèrement fruité du mix de 3 fromages à base de lait vache en  format râpé très pratique, ce fromage râpé fait succomber toute la famille au quotidien. Pour ajouter du fondant ou du croustillant à tous vos gratins, salades et  soupes...
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
        <table class="table table-bordered" style="background-color: #ce2b37;color: #fff;" >
          ...
          <tbody>
            <tr>
              <td><center>Fromage râpé Fiore</center></td>
              <td><center>P00F020702</center></td>
              <td><center>1kg</center></td>
              <td><center>6191581000054</center></td>
              <td><center>120 jours</center></td>
            </tr>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Ffromage-rape-fiore1kg.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
