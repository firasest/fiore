...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/bistecca-di-fiore.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="bistecca-di-fiore" />
        <meta property="og:description"   content="C'est l'enfant naturel du lait, l'extra frai de Fiore. Rien de mieux pour égayer la table qu'une tranche de Bistecca Di Fiore sauté dans un filet d'huile d'olive (ce fromage ne fond pas a la cuisson). Même si ce fromage est fait pour être assaisonné, panné ou sauté, il peut très bien être dégusté Nature." />
        <meta property="og:image"         content="http://fromagefiore.com/images/fraiche/LA-BISTECCA-DI-FIORE.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/fraiche/LA-BISTECCA-DI-FIORE.png" class="img-product swipebox">
									<img class="img-responsive" src="images/fraiche/LA-BISTECCA-DI-FIORE.png" alt="LA-BISTECCA-DI-FIORE" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">BISTECCA DI FIORE</li>
                </ol>
							<h1><span style="color:#1a761d">BISTECCA</span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;"> DI</span><span style="color:#CE2B37"> FIORE</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            C'est l'enfant naturel du lait, l'extra frai de Fiore.
                            Rien de mieux pour égayer la table qu'une tranche de Bistecca Di Fiore sauté dans un filet d'huile d'olive (ce fromage ne fond pas a la cuisson).
                            Même si ce fromage est fait pour être assaisonné, panné ou sauté, il peut très bien être dégusté Nature.
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <!--<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          <span class="fa fa-glass"></span>CLASSIC
        </a>-->
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #669;">
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center> Bistecca di Fiore</center></td>
              <td style="color: #fff"><center>P03F030001</center></td>
              <td style="color: #fff"><center>2.000 kg</center></td>
              <td style="color: #fff"><center>2407812XXXXXX</center></td>
              <td style="color: #fff"><center>15 jours</center></td>
            </tr>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fbistecca-di-fiore.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
  <!--<div class="panel panel-default">
    ...
    <div>
      <p class="panel-body">
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              <td><center> 	> 4 mois</center></td>
              <td><center>corsé</center></td>
              <td><center>très fine et onctueuse</center></td>
              <td><center>meule entière</center></td>
            </tr>
