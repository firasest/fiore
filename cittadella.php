...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/cittadella.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="cittadella" />
        <meta property="og:description"   content="" />
        <meta property="og:image"         content="http://fromagefiore.com/images/presse/cittadella.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/presse/cittadella.png" class="img-product swipebox">
									<img class="img-responsive" src="images/presse/cittadella.png" alt="cittadella" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">CITTADELLA DI FIORE</li>
                </ol>
							<h1><span style="color:#1a761d">CITTADELLA </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">DI </span><span style="color:#CE2B37"> FIORE</span></h1>
							<!--<h5>100G</h5>-->
							<p style="text-align: justify;">
                              La citadella di fiore est fromage au goût fruité ou parfois beurré ou boisé, à la saveur acidulée et salée. Ses arômes sont bien persistants en bouche. Sa texture varie du souple, au ferme et cassant, mais reste moelleuse en bouche donnant une sensation de rondeur. Il peut parfois devenir légèrement piquant lorsqu’il s’affine longuement.
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
       ...
       <table class="table table-bordered" style="background-color: #744a29;">
          ...
          <tbody>
            <tr>
              ...
              <td style="color: #fff"><center>P03F050601</center></td>
              <td style="color: #fff"><center>11.000 kg</center></td>
              <td style="color: #fff"><center>2407817XXXXXX</center></td>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fcittadella.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
