...
<!-- Mirrored from www.directdesign.it/demos/chateau/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Mar 2018 10:21:17 GMT -->
<head>
        <title>Galerie</title>
    ...
    <body>
        ...
        <div class="container-fluid" id="main-container">
            ...
            <?php include("includes/header.php") ?>
				...
				<!-- .page-header -->
				<!--<div class="page-header" style="background-image:url(images/title-3.jpg)" data-stellar-background-ratio="0.2">-->
				...
				<nav id="secondary-nav-bar" class="navbar navbar-default">
                  <div class="container">
                    <ul id="secondary-nav" class="nav navbar-nav">
                        <li><a href="qui-somme-nous.php" style="font-weight: bold;">Qui somme nous</a></li>
                        <li><a href="historique.php" style="font-weight: bold;">Historique</a></li>
                        
                        <li><a href="le-saviez-vous.php" style="font-weight: bold;">Le saviez vous</a></li>
                        <li class="active"><a href="gallery.php" style="font-weight: bold;">Galerie</a></li>
                    </ul>
                  </div>
                </nav>
				<!-- /#secondary-nav-bar -->
                    ...
                    <div class="row">
						<div class="swiper-container gallery-top">
						    <div class="swiper-wrapper">
						        ...
						        <div class="swiper-slide" style="background-image:url(images/gallery-4.jpg)"></div>
						        <div class="swiper-slide" style="background-image:url(images/gallery-5.jpg)"></div>
						        <div class="swiper-slide" style="background-image:url(images/gallery-6.jpg)"></div>
						        <div class="swiper-slide" style="background-image:url(images/gallery-7.jpg)"></div>
						    </div>
						</div>
...
<!-- Mirrored from www.directdesign.it/demos/chateau/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Mar 2018 10:21:49 GMT -->
</html>