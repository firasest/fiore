...
<head>
        <title>gran bastardo di fiore grana padano</title>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/gran-bastardo-di-fiore-grana-padano.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="gran-bastardo-di-fiore-grana-padano" />
        <meta property="og:description"   content="C'est un fromage affiné. Il décline suivant ses stades d'affinage. A un mois, sa pâte sera jaune pâle et prend du caracère, il trouve sa pesonalité a partie de 2 mois d'affinage sa pâte devient alors jaune et assez souple, 'veillé' par le Maître Affineur Fiore, ce fromage exceptionnel saura séduire tous les goûts." />
        <meta property="og:image"         content="http://fromagefiore.com/images/presse/IL-BRAN-BASTARDO.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/presse/IL-BRAN-BASTARDO.png" class="img-product swipebox">
									<img class="img-responsive" src="images/presse/IL-BRAN-BASTARDO.png" alt="IL-BRAN-BASTARDO" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">GRAN BASTARDO DI FIORE</li>
                </ol>
							<h1><span style="color:#1a761d">GRAN </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;"> BASTARDO </span><span style="color:#CE2B37">DI FIORE</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            C'est un fromage affiné. Il décline suivant ses stades d'affinage.
                            A un mois, sa pâte sera jaune pâle et prend du caracère, il trouve sa pesonalité a partie de 2 mois d'affinage sa pâte devient alors jaune et assez souple, "veillé" par le Maître  Affineur Fiore, ce fromage exceptionnel saura séduire tous les goûts.
							</p>
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #744a29;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Gran Bastardo di Fiore</center></td>
              <td style="color: #fff"><center>P03F040301</center></td>
              <td style="color: #fff"><center>6.000 kg</center></td>
              <td style="color: #fff"><center>2407801XXXXXX</center></td>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fgran-bastardo-di-fiore-grana-padano.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
