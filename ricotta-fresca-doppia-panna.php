...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/ricotta-fresca-doppia-panna.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="ricotta-fresca-doppia-panna" />
        ...
        <meta property="og:image"         content="http://fromagefiore.com/images/fraiche/RICOTTA-DOUBLE-CREME.png" />
        ...
        <div class="container-fluid" id="main-container" style="background-image: url(images/nofromage.jpg);">
            ...
            <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/fraiche/RICOTTA-DOUBLE-CREME.png" class="img-product swipebox">
									<img class="img-responsive" src="images/fraiche/RICOTTA-DOUBLE-CREME.png" alt="RICOTTA-DOUBLE-CREME" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">RICOTTA FRESCA DOPPIA PANNA</li>
                </ol>
							<h1><span style="color:#1a761d">RICOTTA </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">FRESCA DOPPIA</span><span style="color:#CE2B37"> PANNA</span></h1>
							<!--<h5>100G</h5>-->
							<p>
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #669;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Ricotta</center></td>
              <td style="color: #fff"><center>P00F020001</center></td>
              <td style="color: #fff"><center>1.300 kg</center></td>
              <td style="color: #fff"><center>2407814XXXXXX</center></td>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fricotta-fresca-doppia-panna.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
