...
<head>
        <title>sicilien aux fines herbes</title>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/sicilien-aux-fines-herbes.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="sicilien-aux-fines-herbes" />
        <meta property="og:description"   content="" />
        <meta property="og:image"         content="http://fromagefiore.com/images/presse/Sicilien-aux-fines-herbes.png" />
        ...
        <div class="container-fluid" id="main-container" style="background-image: url(images/nofromage.jpg);">
            ...
            <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/presse/Sicilien-aux-fines-herbes.png" class="img-product swipebox">
									<img class="img-responsive" src="images/presse/Sicilien-aux-fines-herbes.png" alt="logo" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">SICILIEN AUX FINES HERBES</li>
                </ol>
							<h1><span style="color:#1a761d">SICILIEN </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">AUX FINES</span><span style="color:#CE2B37"> HERBES</span></h1>
							<!--<h5>100G</h5>-->
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #744a29;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Sicilien aux fines herbres</center></td>
              <td style="color: #fff"><center>P03F0300021</center></td>
