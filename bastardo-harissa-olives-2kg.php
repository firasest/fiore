...
<head>
        <title>bastardo harissa olives 2kg</title>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/bastardo-harissa-olives-2kg.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="bastardo-harissa-olives-2kg" />
        <meta property="og:description"   content="Seul Fiore peut oser marier le piquant des ''Peperoni' a la douceur de ce jeune fromage avec une telle harmonie et un tel exotisme. L'olive en est témoin." />
        <meta property="og:image"         content="http://fromagefiore.com/images/presse/BASTARDO-DI-FIORE-+-OLIVE-&-HARISSA.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/presse/BASTARDO-DI-FIORE-+-OLIVE-&-HARISSA.png" class="img-product swipebox">
									<img class="img-responsive" src="images/presse/BASTARDO-DI-FIORE-+-OLIVE-&-HARISSA.png" alt="BASTARDO-DI-FIORE-+-OLIVE-&-HARISSA" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">BASTARDO DI FIORE OLIVES-HARISSA</li>
                </ol>
							<h1><span style="color:#1a761d">BASTARDO </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">DI FIORE </span><span style="color:#CE2B37">OLIVES - HARISSA</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            Seul Fiore peut oser marier le piquant des "Peperoni" a la douceur de ce jeune fromage avec une telle harmonie et un tel exotisme.
                            L'olive en est témoin.
							</p>
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #744a29;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Bastardo Olives Harissa</center></td>
              <td style="color: #fff"><center>P03F010303</center></td>
              <td style="color: #fff"><center>1.800 kg</center></td>
              <td style="color: #fff"><center>2407809XXXXXX</center></td>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fbastardo-harissa-olives-2kg.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
