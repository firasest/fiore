...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/CREME-DE-STRACCHINO.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="CREME-DE-STRACCHINO" />
        <meta property="og:description"   content="Cette recette doit etre réalisée avec une spatule en bois et pas au fouet car on ne doit pas obtenir un mélange lisse.
        ...
        <meta property="og:image"         content="http://fromagefiore.com/images/slide-4.png" />
				...
				<nav id="secondary-nav-bar" class="navbar navbar-default" style="background-color: #074529">
				  <div class="container">
				    <ul id="secondary-nav" class="nav navbar-nav" style="margin-top: 12px;">
				    	...
				    	<div class="col-sm-1"  style="color: #fff"> /</div>
				    	<div class="col-sm-5"><li><a class="active" class="soustitre" style="font-weight: bold;color: #fff;border-bottom: 3px solid #fff">CREME DE STRACCHINO</a></li></div>
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<!--<ol class="breadcrumb">
					                  ...
					                  <li class="active">CREME DE STRACCHINO</li>
				                </ol>-->
								<article class="entry" id="CREME-DE-STRACCHINO">
									<a href="CREME-DE-STRACCHINO.html">
									<figure class="box-1">
										<a href="CREME-DE-STRACCHINO.html"><img alt="slide 4" class="img-responsive" src="images/slide-4.png"></a>
									</figure>
								...
								<div class="row">
								    <div class="col-sm-12 col-sm-offset-10">
								        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2FCREME-DE-STRACCHINO.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
								    </div>
								</div>
