...
<head>
        <title>Primo sale aux poivres</title>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/primo-sale-aux-poivres.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="Primo sale aux poivres" />
        <meta property="og:description"   content="PRIMO SALE AUX POIVRES Ce fromage  Sicilien à l'arôme délicat peut se déguster en apéritif ou sur la pizza. Il ne contient aucun agent de conservation mais seulement du sel. Une fois ouvert vous pouvez le laisser durcir et l'utiliser comme condiment pour vos pâtes, Plus affiné, le primo sale  aux poivres exprime davantage ses qualités comme fromage râpé ou gratiné dans d’innombrables plats.  Ce fromage  vous invite à découvrir un autre versant de la tradition des campagnes siciliennes." />
        <meta property="og:image"         content="http://fromagefiore.com/images/presse/PRIMO-SALE-AUX-POIVRES.png" />
    ...
    <body>
        ...
        <div class="container-fluid" id="main-container" style="background-image: url(images/nofromage.jpg);">
            <div class="row" id="main-row">
             ...
             <header>
                    <nav id="main-nav-bar" class="navbar navbar-default produitFont"  >
                        <div class="container">

                            
                            <!-- navbar-header -->
                            <div class="navbar-header" id="colxs">
                                            <a class="navbar-brand hidden-xs hidden-sm" href="index.html"><img class="lazy" alt="logo" src="images/logo-Fiore-fr-foncé.png" srcset="images/logo-Fiore-fr-foncé.png 1x, images/logo-Fiore-fr-foncé.png 2x"></a>
                                            <a class="navbar-brand hidden-lg hidden-md" href="index.html"><img  class="lazy" alt="logo" src="images/logo.png" srcset="images/logo.png 1x, images/logo.png 2x"></a>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/presse/PRIMO-SALE-AUX-POIVRES.png" class="img-product swipebox">
									<img class="img-responsive" src="images/presse/PRIMO-SALE-AUX-POIVRES.png" alt="PRIMO-SALE-AUX-POIVRES" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">PRIMO SALE AUX POIVRES</li>
                </ol>
							<h1><span style="color:#1a761d">PRIMO </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">SALE AUX</span><span style="color:#CE2B37"> POIVRES</span></h1>
							<!--<h5>100G</h5>-->
							<p style="text-align: justify;">
                            PRIMO SALE AUX POIVRES Ce fromage  Sicilien à l'arôme délicat peut se déguster en apéritif ou sur la pizza. Il ne contient aucun agent de conservation mais seulement du sel.<br>
                             Une fois ouvert vous pouvez le laisser durcir et l'utiliser comme condiment pour vos pâtes, Plus affiné, le primo sale  aux poivres exprime davantage ses qualités comme fromage râpé ou gratiné dans d’innombrables plats.<br>
                             Ce fromage  vous invite à découvrir un autre versant de la tradition des campagnes siciliennes.
							</p>
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #744a29;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Primo sale aux poivres</center></td>
              <td style="color: #fff"><center>P04F0301011</center></td>
              <td style="color: #fff"><center>2kg</center></td>
              <td style="color: #fff"><center>-</center></td>
              <td style="color: #fff"><center>-</center></td>
            </tr>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Frprimo-sale-aux-poivres.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
    ...
    <div class="panel-heading" role="tab" id="headingThree">
      <h4 class="panel-title">
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          <span class="fa fa-star"></span> Awards
        </a>
      </h4>
    </div>
    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
      <p class="panel-body" id="wine-awards">
		<img src="images/award-1.png" alt="chateau" width="720" height="720">
		<img src="images/award-2.png" alt="chateau" width="720" height="611">
		<img src="images/award-3.png" alt="chateau" width="720" height="666">
		<img src="images/award-4.png" alt="chateau" width="720" height="824">
		<img src="images/award-5.png" alt="chateau" width="720" height="720">	  
      </p>
    </div>
  </div>-->
  <!--<div class="panel panel-default">
    ...
    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
      <div class="panel-body">
		<div class="rwd-video">
			<iframe src="http://www.youtube.com/embed/qmNFj94ffrk?rel=0" allowfullscreen="" height="315" width="560"></iframe>
		</div>
      </div>
    </div>
  </div>-->
                            ...
                            <a class="btn btn-primary btn-lg btn-animated btn-style-1" href="cart.html">
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-sm-4 col-sm-offset-4 pad-v text-center">
                <img alt="logo" src="images/logo-Fiore-fr-foncé-footer.png" class="img-responsive1" srcset="images/logo-Fiore-fr-foncé-footer.png 1x, images/logo-Fiore-fr-foncé-footer.png 2x">
              </div>
            </div>
