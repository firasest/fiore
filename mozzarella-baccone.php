...
<head>
        <title>mozzarella baccone</title>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/mozzarella-baccone.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="MOZZARELLA-BOCCONE-DI-FIORE" />
        <meta property="og:description"   content="Tradition itilienne par excellence, la pizza n'est jamais meilleure que garnie de mozzarelle et la mozzarella n'est jamais meilleure que lorqu'elle est la Mozzarelle Di Fiore. Pourquoi ? Parce qu'elle seule a cette faculté a fondre parfaitement et a 'filer' avec gourmandise mais surtout parce qu'elle est si pure si fraîche si lait." />
        <meta property="og:image"         content="http://fromagefiore.com/images/filee/MOZZARELLA-BOCCONE-DI-FIORE.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/filee/MOZZARELLA-BOCCONE-DI-FIORE.png" class="img-product swipebox">
									<img class="img-responsive" src="images/filee/MOZZARELLA-BOCCONE-DI-FIORE.png" alt="MOZZARELLA-BOCCONE-DI-FIORE" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">MOZZARELLA BOCCONE</li>
                </ol>
							<h1><span style="color:#1a761d">MOZZA</span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">RELLA </span><span style="color:#CE2B37"> BOCCONE</span></h1>
							<!--<h5>100G</h5>-->
							<p style="text-align: justify;">
								La Mozzarella fraiche est Le fromage italien le plus consommé !<br>
								La Mozzarella BOCONNE  DI FIORE la plus courante elle est fabriquée à partir de lait de vache ce qui lui confère un goût frais de lait et de crème. Elle est caractérisée comme toute Mozzarella par sa couleur blanche et une surface lisse ainsi qu’une texture moelleuse, fondante et humide.<br>
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  <div class="panel panel-default">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #0f5192;">
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Boccone</center></td>
              <td style="color: #fff"><center>P01F010001</center></td>
              <td style="color: #fff"><center>125 g</center></td>
              <td style="color: #fff"><center>6191581000016</center></td>
              <td style="color: #fff"><center>30 jours</center></td>
            </tr>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fmozzarella-baccone.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
