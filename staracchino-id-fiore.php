...
<head>
        <title>STRACCHINO DI FIORE</title>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/staracchino-id-fiore.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="staracchino-id-fiore" />
        <meta property="og:description"   content="Le < stracchino > est un fromage originaire de la Lombardie. Sa saveur acidulée est assez unique. Son nom dérive du fait qu'autre fois, le lait employé pour ce fromage était celui des , i.e. des vaches qui rentraient < fatiguées > des pâturages alpins. Nous avons usé de tout notre savoir-faire pour que le Stracchino di Fiore soit identique au fromage italien d'antan." />
        <meta property="og:image"         content="http://fromagefiore.com/images/fraiche/STRACCHINO%20DI%20FIORE.png" />
    ...
    <body>
        ...
        <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/fraiche/STRACCHINO DI FIORE.png" class="img-product swipebox">
									<img class="img-responsive" src="images/fraiche/STRACCHINO DI FIORE.png" alt="STRACCHINO DI FIORE" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">STRACCHINO DI FIORE</li>
                </ol>
							<h1><span style="color:#1a761d">STRACCHINO</span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;"> DI</span><span style="color:#CE2B37"> FIORE</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                           Le « stracchino » est un fromage au lait de vache originaire de la Lombardie. Sa saveur un peu piquante est assez unique. Son nom dérive du fait que dans le vieux temps, le lait employé pour ce fromage était celui des « vacche stracche »,  des vaches qui rentraient « fatiguées » des pâturages.
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #669;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Stracchino di Fiore</center></td>
              <td style="color: #fff"><center>P01F020101</center></td>
              <td style="color: #fff"><center>125g</center></td>
              <td style="color: #fff"><center>6191581000870</center></td>
              <td style="color: #fff"><center>21 jours</center></td>
            </tr>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fstaracchino-id-fiore.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>					
