...
<head>
        <title>sicilien aux persil</title>
        ...
        <meta property="og:url"           content="file:///C:/fromage-fiore.tn/sicilien-aux-persil.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="sicilien-aux-persil" />
        <meta property="og:description"   content="" />
        <meta property="og:image"         content="http://fromagefiore.com/images/presse/Sicilien-aux-persil.png" />
        ...
        <div class="container-fluid" id="main-container" style="background-image: url(images/nofromage.jpg);">
          ...
          <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/presse/Sicilien-aux-persil.png" class="img-product swipebox">
									<img class="img-responsive" src="images/presse/Sicilien-aux-persil.png" alt="Sicilien-aux-persil" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">SICILIEN AUX PERSILES</li>
                </ol>
							<h1><span style="color:#1a761d">SICILIEN </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">AUX </span><span style="color:#CE2B37"> PERSILES</span></h1>
							<!--<h5>100G</h5>-->
							<p style="text-align: justify;">
                          Les fromages siciliens sont les fruits d'une longue et ancienne tradition de la Sicile. Ces fromages  sont classés selon leur typicité, issue des caractéristiques de leur terroir d’origine. Des terroirs qui sont définis par leur climat et leur sol , ce Fromage produit avec le lait de vache  il a une forme cylindrique avec des faces planes ou légèrement concaves, ca croûte est blanche- jaunâtre, avec la surface rugueuse laissée par la corbeille. <br>
                          Fiore vous offre le plaisir de gouter son fromage sicilien  à travers cinq gouts different <br>
                          Le sicilen aux fines herbees <br>
                          Le sicilien aux Thym <br>
                          Le sicilien aux herbes d’ognion <br> 
                          Le sicilien à l’ail <br>
                          Le sicilien aux persils .
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #744a29;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Sicilien aux persiles</center></td>
              <td style="color: #fff"><center>P03F0300024</center></td>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fsicilien-aux-persil.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
