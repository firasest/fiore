...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/caciotta-di-fiore.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="caciotta-di-fiore" />
        <meta property="og:description"   content="C'est un fromage produit avec du lait de vache entier. Il est travaillé de façon a ce qu'il reste toujours assez souple, plus ou moins relevé, agréable aussi bien a table que dans la cuisine. Son nom dérive de 'cacio' (fromage), ce qui indique a quel point la consommation et la diffusion de ce fromage est encore, en Italie, généralisée. Il s'agit d'un produit assez frais 20 a 25 jours d'affinage, et quand il est plus affiné (deux mois de maturation environ) il devient La Cacciotta Vecchia Di Fiore: il a alors une saveur plus accentuée." />
        <meta property="og:image"         content="http://fromagefiore.com/images/presse/CACIOTTA-DI-FIORE.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/presse/CACIOTTA-DI-FIORE.png" class="img-product swipebox">
									<img class="img-responsive" src="images/presse/CACIOTTA-DI-FIORE.png" alt="CACIOTTA-DI-FIORE" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">CACIOTTA DI FIORE</li>
                </ol>
							<h1><span style="color:#1a761d">CACIOTTA </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">DI</span><span style="color:#CE2B37"> FIORE</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            C'est un fromage produit avec du lait de vache entier. Il est travaillé de façon a ce qu'il reste toujours assez souple, plus ou moins relevé, agréable aussi bien a table que dans la cuisine. Son nom dérive de "cacio" (fromage), ce qui indique a quel point la consommation et la diffusion de ce fromage est encore, en Italie, généralisée. Il s'agit d'un produit assez frais 20 a 25 jours d'affinage, et quand il est plus affiné (deux mois de maturation environ) il devient La Cacciotta Vecchia Di Fiore: il a alors une saveur plus accentuée.
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #744a29;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center> Cacciotta di Fiore</center></td>
              <td style="color: #fff"><center>P02F020301</center></td>
              <td style="color: #fff"><center>0.500 kg</center></td>
              <td style="color: #fff"><center>2407803XXXXXX</center></td>
              <td style="color: #fff"><center>90 jours</center></td>
            </tr>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fcaciotta-di-fiore.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
