...
<head>
        ...
        <meta property="og:url"           content="file:///C:/fromage-fiore.tn/bastardo-di-fiore.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="bastardo-di-fiore" />
        ...
        <meta property="og:image"         content="http://fromagefiore.com/images/presse/Bastardo-Di-Fiore.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/presse/Bastardo-Di-Fiore.png" class="img-product swipebox">
									<img class="img-responsive" src="images/presse/Bastardo-Di-Fiore.png" alt="Bastardo-Di-Fiore" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
							<ol class="breadcrumb">
                  ...
                  <li class="active">BASTARDO DI FIORE</li>
                </ol>
							<h1><span style="color:#1a761d">BASTARDO </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">DI</span><span style="color:#CE2B37"> FIORE</span></h1>
							<!--<h5>100G</h5>-->
							<p>
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
        <table class="table table-bordered" style="background-color: #744a29;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center> Bastardo di Fiore</center></td>
              <td style="color: #fff"><center>-</center></td>
              <td style="color: #fff"><center>3 kg</center></td>
              <td style="color: #fff"><center>2407807XXXXXX</center></td>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fbastardo-di-fiore.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
