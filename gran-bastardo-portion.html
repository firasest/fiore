...
<head>
        <title>gran bastardo portion</title>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/gran-bastardo-portion.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="gran-bastardo-portion" />
        <meta property="og:description"   content="" />
        <meta property="og:image"         content="http://fromagefiore.com/images/presse/GRAN%20BASTARDO%20DI%20FIORE.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/presse/GRAN BASTARDO DI FIORE.png" class="img-product swipebox">
									<img class="img-responsive" src="images/presse/GRAN BASTARDO DI FIORE.png" alt="GRAN BASTARDO DI FIORE" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">GRAN BASTARDO PORITION</li>
                </ol>
							<h1><span style="color:#1a761d">GRAN </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">BASTARDO</span><span style="color:#CE2B37"> PORITION</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            Le Grand Bastardo di fiore c'est un fromage affiné  avec un goût doux et légèrement aromatique, qui peut varier en fonction de la transformation, du fourrage et du pâturage. 
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #744a29;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Gran Bastardo di Fiores</center></td>
              <td style="color: #fff"><center>P03F040302</center></td>
