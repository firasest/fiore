...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/fromage-rape-150g.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="fromage-rape-150g" />
        <meta property="og:description"   content="Retrouvez le bon goût généreux et légèrement fruité du mix de 3 fromages à base de lait en  format râpé très pratique, ce fromage râpé fait succomber toute la famille au quotidien. Pour ajouter du fondant ou du croustillant à tous vos gratins..." />
        <meta property="og:image"         content="http://fromagefiore.com/images/rape/FROMAGE-R%C3%84PE-DI-FIORE-150G.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/rape/FROMAGE-RÄPE-DI-FIORE-150G.png" class="img-product swipebox">
									<img class="img-responsive" src="images/rape/FROMAGE-RÄPE-DI-FIORE-150G.png" alt="FROMAGE-RÄPE-DI-FIORE-150G" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active" style="text-transform: uppercase;">Fromage râpé DI FIORE 150G</li>
                </ol>
							<h1><span style="color:#1a761d">FROMAGE </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;"> râpé DI FIORE</span><span style="color:#CE2B37"> 150G</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                           Retrouvez le bon goût généreux et légèrement fruité du mix de 3 fromages à base de lait en  format râpé très pratique, ce fromage râpé fait succomber toute la famille au quotidien. Pour ajouter du fondant ou du croustillant à tous vos gratins...
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  <div class="panel panel-default">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #ce2b37;color: #fff;" >
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td><center>Mix Râpé Fiore </center></td>
              <td><center>P00F020701</center></td>
              <td><center>150g</center></td>
              <td><center>6191581000047</center></td>
              <td><center>45 jours</center></td>
            </tr>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Ffromage-rape-150g.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
