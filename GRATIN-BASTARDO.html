...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/GRATIN-BASTARDO.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="GRATIN-BASTARDO" />
        <meta property="og:description"   content="Couper le pain en petits morceaux dans un saladier, faire chauffer le lait puis le verser sur le pain, couvrir, laisser reposer 15 minutes.
        ...
        <meta property="og:image"         content="http://fromagefiore.com/images/slide-6.png" />
...
<header>
				...
				<nav id="secondary-nav-bar" class="navbar navbar-default" style="background-color: #074529">
				  <div class="container">
				    <ul id="secondary-nav" class="nav navbar-nav" style="margin-top: 12px;">
				    	...
				    	<div class="col-sm-1"  style="color: #fff"> /</div>
				    	<div class="col-sm-5"><li><a class="active" class="soustitre" style="font-weight: bold;color: #fff;border-bottom: 3px solid #fff">GRATIN BASTARDO</a></li></div>
				...
				<section id="blog">
					...
					<!--<ol class="breadcrumb">
					                  ...
					                  <li class="active">GRATIN BASTARDO</li>
				    </ol>-->
						...
						<div class="row">
							...
							<div class="col-sm-8">
								...
								<article class="entry" id="GRATIN-BASTARDO">
									<figure class="box-1">
										<a><img alt="slide 6" class="img-responsive" src="images/slide-6.png"></a>
									</figure>
								...
								<div class="row">
								    <div class="col-sm-12 col-sm-offset-10">
								        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2FGRATIN-BASTARDO.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
								    </div>
								</div>
