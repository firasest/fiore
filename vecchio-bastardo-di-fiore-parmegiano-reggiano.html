...
<head>
        <title>VECCHIO BASTARDO DI FIORE PARMEGIANO REGGIANO</title>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/vecchio-bastardo-di-fiore-parmegiano-reggiano.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="vecchio-bastardo-di-fiore-parmegiano-reggiano" />
        ...
        <meta property="og:image"         content="http://fromagefiore.com/images/presse/IL-VECCHIO-BASTARDO.png" />
  ...
  <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/presse/IL-VECCHIO-BASTARDO.png" class="img-product swipebox">
									<img class="img-responsive" src="images/presse/IL-VECCHIO-BASTARDO.png" alt="IL VECCHIO BASTARDO" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">VECCHIO BASTARDO DI FIORE</li>
                </ol>
							<h1><span style="color:#1a761d">VECCHIO </span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;">BASTARDO DI  </span><span style="color:#CE2B37"> FIORE</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            Notre prédilection va a ce fromage, il est authentique, généreux, au goût fruité et au parfum inimitable, c'est le résultat d'un affinage long et attentif.Prfanes s'abstenir.
							</p>
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
       ...
       <table class="table table-bordered" style="background-color: #744a29;">
          ...
          <tbody>
            <tr>
              ...
              <td style="color: #fff"><center>P04F040601</center></td>
              <td style="color: #fff"><center>4.500 kg</center></td>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fvecchio-bastardo-di-fiore-parmegiano-reggiano.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
