...
<head>
        <title>rape primo mozzarella</title>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/rape-primo-mozzarella.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="rape-primo-mozzarella" />
        <meta property="og:description"   content="Idéal pour les pizzas  et Fondant à la cuisson 
                                                   Préparation rape Primo  a la Mozzarella - Marque FIORELLA 100g" />
        <meta property="og:image"         content="http://fromagefiore.com/images/a-base-alimentaire/Fiorella-R%C3%A2p%C3%A9-Primo-mozzarella.png" />
        ...
        <div class="container-fluid" id="main-container" style="background-image: url(images/nofromage.jpg);">
            ...
            <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/a-base-alimentaire/Fiorella-Râpé-Primo-mozzarella.png" class="img-product swipebox">
									<img class="img-responsive" src="images/a-base-alimentaire/Fiorella-Râpé-Primo-mozzarella.png" alt="Fiorella-Râpé-Primo-mozzarella" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">RAPE PRIMO MOZZARELLA 100g</li>
                </ol>
							<h1><span style="color:#1a761d">RAPE</span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;"> PRIMO</span><span style="color:#CE2B37"> MOZZARELLA 100g</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            Idéal pour les pizzas  et Fondant à la cuisson <br>
                            Préparation rape Primo  a la Mozzarella - Marque FIORELLA 100g
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #1a761d;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Rapé primo Mozzarelle </center></td>
              <td style="color: #fff"><center>FA02F0302</center></td>
              <td style="color: #fff"><center>100 g</center></td>
              <td style="color: #fff"><center>619158100006</center></td>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Frape-primo-mozzarella.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
