...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/TORTAFIORE.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="TORTAFIORE" />
        <meta property="og:description"   content="Mettez du papier cuisson puis la pâte brisée dans un moule a tarte de 24 cm de diametre et de 5 de haut. Placez le tout au frigo pendant 15 minutes et 
        ...
        <meta property="og:image"         content="http://fromagefiore.com/images/slide-3.png" />
                            ...
                            <div class="collapse navbar-collapse" id="navigation">
                                ...
                                <ul id="main-nav" class="nav navbar-nav">
                                   ...
                                   <li  >
                                    ...
                                    <li class="active"><a href="recette.html">Recettes</a></li>
				...
				<nav id="secondary-nav-bar" class="navbar navbar-default" style="background-color: #074529">
				  <div class="container">
				    <ul id="secondary-nav" class="nav navbar-nav" style="margin-top: 12px;">
				    	<div class="col-sm-2"><li><a href="index.html" class="soustitre" style="text-transform: uppercase;font-weight: bold;color: #fff;">Accueil</a></li></div>
				    	<div class="col-sm-1" style="color: #fff"> /</div>
				    	<div class="col-sm-2"><li><a href="recette.html" class="soustitre" style="text-transform: uppercase;font-weight: bold;color: #fff;">Recette</a></li></div>
				    	<div class="col-sm-1"  style="color: #fff"> /</div>
				    	<div class="col-sm-5"><li><a class="active" class="soustitre" style="font-weight: bold;color: #fff;border-bottom: 3px solid #fff">TORTAFIORE</a></li></div>
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<!--<ol class="breadcrumb">
					                  ...
					                  <li><a href="recette.html" style="text-transform: uppercase;">Recette</a></li>
					                  <li class="active">TORTAFIORE</li>
				                </ol>-->
								<article class="entry" id="TORTAFIORE">
									<a>
									<figure class="box-1">
										<a><img alt="slider 3" class="img-responsive" src="images/slide-3.png"></a>
									</figure>
								...
								<div class="row">
								    <div class="col-sm-12 col-sm-offset-10">
								        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2FTORTAFIORE.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
								    </div>
								</div>
