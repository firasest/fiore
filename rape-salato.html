...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/rape-salato.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="rape-salato" />
        <meta property="og:description"   content="Moelleux ,Salé, et Fondant a la cuissant
                                                   Préparation rape SALATO - Marque FIORELLA 100g" />
        <meta property="og:image"         content="http://fromagefiore.com/images/a-base-alimentaire/R%C3%A2p%C3%A9%20salato%20fiorella%201%20kg.png" />
 ...
 <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/a-base-alimentaire/Râpé salato fiorella 1 kg.png" class="img-product swipebox">
									<img class="img-responsive" src="images/a-base-alimentaire/Râpé salato fiorella 1 kg.png" alt="Râpé salato fiorella 1 kg" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">RAPE 1KG SALATO</li>
                </ol>
							<h1><span style="color:#1a761d">RAPE</span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;"> 1KG</span><span style="color:#CE2B37"> SALATO</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            Moelleux  ,Salé, et Fondant a la cuissant<br> 
                            Préparation rape SALATO  - Marque FIORELLA 100g
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #1a761d;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Rapé Salato </center></td>
              <td style="color: #fff"><center>SAL1</center></td>
              <td style="color: #fff"><center>1 kg</center></td>
              <td style="color: #fff"><center>6191581000702</center></td>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Frape-salato.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>							
