...
<head>
        ...
        <meta property="og:url"           content="http://fromagefiore.com/mozzarella-filone.html" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="mozzarella-filone" />
        ...
        <meta property="og:image"         content="http://fromagefiore.com/images/filee/LA%20MOZZARELLA%20FILONE%20DI%20FIORE.png" />
            ...
            <div class="row" id="main-row">
             ...
             <header>
                ...
                <div class="container">
                    <div class="row">
	                    ...
	                    <section id="product-sheet" class="clearfix">
							<div class="col-sm-4 col-sm-offset-1-">
								<a href="images/filee/LA MOZZARELLA FILONE DI FIORE.png" class="img-product swipebox">
									<img class="img-responsive" src="images/filee/LA MOZZARELLA FILONE DI FIORE.png" alt="LA MOZZARELLA FILONE DI FIORE" width="300" height="600">
								</a>
							</div>
							<div class="col-sm-8">
								<ol class="breadcrumb">
                  ...
                  <li class="active">MOZZARELLA FILONE 100% LAIT</li>
                </ol>
							<h1><span style="color:#1a761d">MOZZARELLA</span><span style="color:#fff5ee;text-shadow: #000000 1px 1px, #000000 -1px 1px, #000000 -1px -1px, #000000 1px -1px;"> FILONE</span><span style="color:#CE2B37"> 100% LAIT</span></h1>
							<!--<h5>100G</h5>-->
							<p>
                            Tradition itilienne par excellence, la pizza n'est jamais meilleure que garnie de mozzarelle et la mozzarella n'est jamais meilleure que  lorqu'elle est la Mozzarelle Di Fiore.
                            Pourquoi ? Parce qu'elle seule a cette faculté a fondre parfaitement et a "filer" avec gourmandise mais surtout parce qu'elle est si pure si fraîche si lait. 
							</p>
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div>
      <p class="panel-body">
       <table class="table table-bordered" style="background-color: #0f5192;">
          ...
          <tbody>
            <tr>
              <td style="color: #fff"><center>Filone</center></td>
              <td style="color: #fff"><center>P01F020001</center></td>
              <td style="color: #fff"><center>1.200 g</center></td>
              <td style="color: #fff"><center>2407805XXXXXX</center></td>
              <td style="color: #fff"><center>45 jours</center></td>
            </tr>
  ...
  <div class="row">
    <div class="col-sm-12 col-sm-offset-10">
        <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Ffromagefiore.com%2Fmozzarella-filone.html&layout=button&size=large&mobile_iframe=true&width=89&height=28&appId" width="89" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    </div>
  </div>
